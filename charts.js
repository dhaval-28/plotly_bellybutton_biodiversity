...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Deliverable 3- gauge chart - # 1. Create a variable that filters the metadata array for the object with the desired sample number.
    var metadataArray = data.metadata.filter(sampleObj => sampleObj.id == sample);

    //  5. Create a variable that holds the first sample in the array.
    var sampleresult = sampleArray[0];
    // Deliverable 3- gauge chart - # 2. Create a variable that holds the first sample in the metadata array.
    ...
    // Deliverable 3- gauge chart - #  3. Create a variable that holds the washing frequency.
